...
namespace Embedded_Signatures.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var embed = await signerService.CreateDocument(prescription.PatientName , prescription.MedicationName , prescription.Identifier , prescription.AllowElectronicSignature);
