...
namespace Embedded_Signatures.Controllers
{
    public class SignatureController : Controller
    {
        ...
        public async Task<string> UpdateAndEmbedSignatureRequest(Boolean allowElectronicSignature = false)
        {
        ...
        {
            var embedView = await UpdateAndEmbedSignatureRequest(false);
            return View();
        }
        ...
        {
            var embedView = await UpdateAndEmbedSignatureRequest(true);
            return View();
        }
